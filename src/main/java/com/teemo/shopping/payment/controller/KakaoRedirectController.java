package com.teemo.shopping.payment.controller;
...
import com.teemo.shopping.payment.service.kakaopay.KakaopayPaymentOnRedirectService;
...
public class KakaoRedirectController {
    ...
    public RedirectView success(KakaoRedirectParameter kakaoRedirectParameter) {
        ...
        return new RedirectView(kakaoRedirectParameter.getNextRedirect());
    }
